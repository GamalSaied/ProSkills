...
this.customPaneSettings=f;this.s={NoActionRegen:!1,clearing:!1,colOpts:[],deselect:!1,displayed:!1,dt:a,dtPane:void 0,filteringActive:!1,firstSet:!0,forceViewTotal:!1,index:c,indexes:[],lastNoAction:!1,lastSelect:!1,listSet:!1,name:void 0,redraw:!1,rowData:{arrayFilter:[],arrayOriginal:[],arrayTotals:[],bins:{},binsOriginal:{},binsTotal:{},filterMap:new Map,totalOptions:0},scrollTop:0,searchFunction:void 0,selectPresent:!1,serverSelect:[],serverSelecting:!1,showFiltered:!1,tableLength:null,updating:!1};
...
u=0;for(d=m.arrayFilter.length;u<d;u++){k=!1;w=0;for(var H=this.s.serverSelect;w<H.length;w++)b=H[w],b.filter===m.arrayFilter[u].filter&&(k=!0);if(this.s.dt.page.info().serverSide&&(!this.c.NoActionPanes||this.c.NoActionPanes&&0!==m.bins[m.arrayFilter[u].filter]||this.c.NoActionPanes&&null!==e||k))for(k=this.addRow(m.arrayFilter[u].display,m.arrayFilter[u].filter,e?m.binsTotal[m.arrayFilter[u].filter]:m.bins[m.arrayFilter[u].filter],this.c.viewTotal||e?String(m.binsTotal[m.arrayFilter[u].filter]):m.bins[m.arrayFilter[u].filter],
m.arrayFilter[u].sort,m.arrayFilter[u].type),w=0,H=this.s.serverSelect;w<H.length;w++)b=H[w],b.filter===m.arrayFilter[u].filter&&(this.s.serverSelecting=!0,k.select(),this.s.serverSelecting=!1);else this.s.dt.page.info().serverSide||!m.arrayFilter[u]||void 0===m.bins[m.arrayFilter[u].filter]&&this.c.NoActionPanes?this.s.dt.page.info().serverSide||this.addRow("",B,B,"","",""):this.addRow(m.arrayFilter[u].display,m.arrayFilter[u].filter,m.bins[m.arrayFilter[u].filter],m.binsTotal[m.arrayFilter[u].filter],
...
b&&(0<this.s.rowData.totalOptions&&!this.s.dt.page.info().serverSide||this.s.dt.page.info().serverSide&&0<this.s.tableLength)?a/this.s.rowData.totalOptions:1};h.prototype._updateCommon=function(a){void 0===a&&(a=!1);if(!(this.s.dt.page.info().serverSide||void 0===this.s.dtPane||this.s.filteringActive&&!this.c.NoActionPanes&&!0!==a||!0===this.c.NoActionPanes&&!0===this.s.selectPresent||this.s.lastSelect&&this.s.lastNoAction)){a=this.s.colOpts;var b=this.s.dtPane.rows({selected:!0}).data().toArray(),c=
this.s.rowData;this.s.dtPane.clear();if(this.colExists){0===c.arrayFilter.length?this._populatePane(!this.s.filteringActive):this.c.NoActionPanes&&this.s.dt.rows().data().toArray().length===this.s.dt.rows({search:"applied"}).data().toArray().length?(c.arrayFilter=c.arrayOriginal,c.bins=c.binsOriginal):(this.c.viewTotal||this.c.NoActionPanes)&&this._populatePane(!this.s.filteringActive);this.c.viewTotal?this._detailsPane():c.binsTotal=c.bins;this.c.viewTotal&&!this.c.NoActionPanes&&(c.arrayFilter=c.arrayTotals);
for(var e=function(k){if(k&&(void 0!==c.bins[k.filter]&&0!==c.bins[k.filter]&&d.c.NoActionPanes||!d.c.NoActionPanes||d.s.clearing)){var p=d.addRow(k.display,k.filter,d.c.viewTotal?void 0!==c.bins[k.filter]?c.bins[k.filter]:0:c.bins[k.filter],d.c.viewTotal?String(c.binsTotal[k.filter]):c.bins[k.filter],k.sort,k.type),m=b.findIndex(function(x){return x.filter===k.filter});-1!==m&&(p.select(),b.splice(m,1))}},d=this,f=0,g=c.arrayFilter;f<g.length;f++)e(g[f])}if(void 0!==a.searchPanes&&void 0!==a.searchPanes.options||
...
paneButton:"dtsp-paneButton",paneInputButton:"dtsp-paneInputButton",pill:"dtsp-pill",rotated:"dtsp-rotated",search:"dtsp-search",searchCont:"dtsp-searchCont",searchIcon:"dtsp-searchIcon",searchLabelCont:"dtsp-searchButtonCont",selected:"dtsp-selected",smallGap:"dtsp-smallGap",subRow1:"dtsp-subRow1",subRow2:"dtsp-subRow2",subRowsContainer:"dtsp-subRowsContainer",title:"dtsp-title",topRow:"dtsp-topRow"};h.defaults={NoActionPanes:!1,clear:!0,collapse:!0,combiner:"or",container:function(a){return a.table().container()},
...
d&&0!==d&&(f=b[0].index);p=0;for(m=this.s.panes;p<m.length;p++)if(k=m[p],void 0!==k.s.dtPane){g=!0;k.s.filteringActive=!0;if(-1!==e&&null!==e&&e===k.s.index||!1===c||k.s.index===f)g=!1,k.s.filteringActive=!1;k.updatePane(g?c:!1)}if(0<b.length&&(b.length<this.s.selectionList.length||a))for(this._NoActionRegen(b,d),g=b[b.length-1].index,e=0,a=this.s.panes;e<a.length;e++)k=a[e],k.s.lastSelect=k.s.index===g;else if(0<b.length)for(k=0,a=this.s.panes;k<a.length;k++)if(b=a[k],void 0!==b.s.dtPane){g=!0;b.s.filteringActive=
...
h.prototype._getState=function(){var a=this.s.dt.state.loaded();a&&a.searchPanes&&void 0!==a.searchPanes.selectionList&&(this.s.selectionList=a.searchPanes.selectionList)};h.prototype._makeNoActionSelections=function(a){for(var b=0;b<a.length;b++)for(var c=function(f){if(f.s.index===a[b].index&&void 0!==f.s.dtPane){b===a.length-1&&(f.s.lastNoAction=!0);0<f.s.dtPane.rows({selected:!0}).data().toArray().length&&void 0!==f.s.dtPane&&(f.setClear(!0),f.clearPane(),f.setClear(!1));for(var g=function(m){var x=
!1;f.s.dtPane.rows().every(function(z){void 0!==f.s.dtPane.row(z).data()&&void 0!==m&&f.s.dtPane.row(z).data().filter===m.filter&&(x=!0,f.s.dtPane.row(z).select())});x||f.addRow(m.display,m.filter,0,m.total,m.sort,m.type,m.className).select()},k=0,p=a[b].rows;k<p.length;k++)g(p[k]);f.s.scrollTop=v(f.s.dtPane.table().node()).parent()[0].scrollTop;f.s.dtPane.draw();f.s.dtPane.table().node().parentNode.scrollTop=f.s.scrollTop;f.s.lastNoAction=!1}},e=0,d=this.s.panes;e<d.length;e++)c(d[e])};h.prototype._paneDeclare=
...
this.s.dt.page.len()),this.s.dt.draw("page"));this.s.stateRead=!0;if(this.c.viewTotal&&!this.c.NoActionPanes)for(c=0,e=this.s.panes;c<e.length;c++)g=e[c],g.updatePane();this._checkMessage();a.on("preDraw.dtsps",function(){b.s.updating||b.s.paging||(!b.c.NoActionPanes&&!b.c.viewTotal||b.s.dt.page.info().serverSide?(b._updateFilterCount(),b._updateSelection()):b.redrawPanes(b.c.viewTotal),b.s.filterPane=-1);b.s.paging=!1});v(window).on("resize.dtsp",A.util.throttle(function(){b.resizePanes()}));this.s.dt.on("stateSaveParams.dtsp",
