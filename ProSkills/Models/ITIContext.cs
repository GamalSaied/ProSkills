...
namespace ProSkills.Models
{
    ...
    public class ITIContext : IdentityDbContext<ApplicationUser>
    {
        ...
        new CourseTrainee { Id = 94, CourseId = 14, TraineeId = 1, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 95, CourseId = 15, TraineeId = 2, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 96, CourseId = 16, TraineeId = 3, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 97, CourseId = 17, TraineeId = 4, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 98, CourseId = 18, TraineeId = 5, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 99, CourseId = 19, TraineeId = 6, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
        new CourseTrainee { Id = 100, CourseId = 20, TraineeId = 7, Points = random2.Next(0, 101) * 10, Result = (decimal)(random2.NextDouble() * 100) },
